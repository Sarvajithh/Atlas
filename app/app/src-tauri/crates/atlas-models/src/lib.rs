...
pub use engines::{
    generate_flashcards, generate_quiz, generate_revision_plan, EnginePool, OllamaEngine,
};
...
pub use study_output::{
    parse_flashcard_response, parse_quiz_response, parse_revision_plan_response,
    GeneratedFlashcardSet, GeneratedQuiz, GeneratedRevisionPlan,
};
