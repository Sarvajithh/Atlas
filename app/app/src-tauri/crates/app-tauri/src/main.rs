...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::assistant::assistant_get_quiz,
            commands::assistant::assistant_list_quizzes,
            commands::assistant::assistant_list_flashcard_sets,
            commands::assistant::assistant_list_revision_plans,
            commands::assistant::assistant_submit_quiz_answer,
            ...
            commands::memory::memory_list_weak_topics,
