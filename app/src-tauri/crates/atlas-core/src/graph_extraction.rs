...
//! a structured-output reasoning task over already-parsed/chunked text,
//! not a new Engine role (§14.1's frozen role table; the same "feature
//! built on an existing role" pattern `atlas-models::engines` already uses
//! for Quiz/Flashcard/Revision Planner).
